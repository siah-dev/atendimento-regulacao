...
class Select2 extends InputWidget
{
    ...
    protected function renderToggleAll()
    {
        ...
        $settings = array_replace_recursive([
            'selectLabel' => '<i class="glyphicon glyphicon-unchecked"></i>' . Yii::t('kvselect', 'Marcar todos'),
            'unselectLabel' => '<i class="glyphicon glyphicon-check"></i>' . Yii::t('kvselect', 'Desmarcar todos'),
            'selectOptions' => [],
            'unselectOptions' => [],
